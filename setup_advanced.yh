...
if ($?PBS_O_WORKDIR) then
   ...
   setenv TMPDIR /nobackup/$USER/temp
   mkdir -p $TMPDIR
endif
...
setenv case            test_yh001
#setenv compset        HIST_CAM60%WCCM_CLM50%SP_CICE%PRES_DOCN%DOM_SROF_SGLC_SWAV
setenv compset         FXHIST
#setenv compset         HIST_CAM40%WXIE_CLM45%SP_CICE%PRES_DOCN%DOM_RTM_SGLC_SWAV
#setenv compset         FXHIST_CAM60%WXIE_CLM50%SP_CICE%PRES_DOCN%DOM_SGLC_SWAV_SIAC_SESP
setenv user_grid       ''
#      alias: f09_f09_mg17 (only for compsets that are not _POP and no CISM)
setenv resolution      f19_f19
#setenv cesmtag         cesm_2_1_multi_inst
setenv cesmtag         release-cesm2.1.5
#setenv cesmtag         release-cesm2.1.4
#setenv cesmtag         release-cesm2.2.0
...
setenv mach         pleiades-bro
setenv cesmdata     /nobackup/fvitt/csm/inputdata
setenv cesmroot     /nobackup/yhozumi1/WACCMX-DART/WX_source_code/release-cesm2.1.5
setenv sourcemods   /nobackup/${USER}/WACCMX-DART/scripts/SourceMods
setenv caseroot     /nobackup/${USER}/${case}
setenv dartroot     /home1/${USER}/dart/recam

setenv cime_output  /nobackup/${USER}
setenv archdir      ${cime_output}/${case}/archive

setenv baseobsdir   /nobackup/${USER}/WACCMX-DART/Observations
...
setenv refcase     waccmx_dart_h2o_2011
#setenv refcase     f.e2_0_exp10f_295.FXHIST_1918.f19_f19.WACCMX_kzzFix.001
...
setenv stagedir /nobackup/npadatel/archive/waccmx_dart_h2o_2011/rest/${reftimestamp}
#setenv stagedir /nobackup/${USER}/WACCMX-DART/archive/waccmx_ic/${reftimestamp}
# or on the HPSS:
...
# ==============================================================================
./xmlchange CPL_PIO_STRIDE=1
./xmlchange CPL_PIO_REARRANGER=1
./xmlchange ATM_PIO_STRIDE=1
./xmlchange ATM_PIO_REARRANGER=1
./xmlchange LND_PIO_STRIDE=1
./xmlchange LND_PIO_REARRANGER=1
./xmlchange ICE_PIO_STRIDE=1
./xmlchange ICE_PIO_REARRANGER=1
./xmlchange OCN_PIO_STRIDE=1
./xmlchange OCN_PIO_REARRANGER=1
./xmlchange ROF_PIO_STRIDE=1
./xmlchange ROF_PIO_REARRANGER=1
./xmlchange GLC_PIO_STRIDE=1
./xmlchange GLC_PIO_REARRANGER=1
./xmlchange WAV_PIO_STRIDE=1
./xmlchange WAV_PIO_REARRANGER=1
./xmlchange --id ADD_TO_SHELL --val "module load python3/3.11.5" --append
# ==============================================================================
...
xmlchange DIN_LOC_ROOT=${cesmdata}
xmlchange DIN_LOC_ROOT_CLMFORC=${cesmdata}/atm/datm7/
